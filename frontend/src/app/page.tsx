...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      {/* Hero Section */}
      <section className="text-center mb-16 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-12 rounded-lg shadow-xl">
        ...
        <div className="flex justify-center gap-6">
          <Link
            href="/register"
            className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
          >
            Get Started
          </Link>
          <Link
      ...
      <section className="grid md:grid-cols-3 gap-8 mb-16">
        {examTypes.map((exam) => (
          ...
          >
            <div className={`${exam.color} p-8 text-white h-full shadow-xl hover:shadow-2xl rounded-lg`}>
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 py-8 bg-gray-50 rounded-lg shadow-md">
        {[
          ...
          <div
            key={feature.title}
            className="p-6 rounded-lg border border-gray-300 bg-white hover:border-blue-500 transition-colors transform hover:scale-105 shadow-md hover:shadow-xl"
          >
      ...
      <section className="text-center py-16 bg-blue-600 text-white rounded-lg shadow-lg mt-16">
